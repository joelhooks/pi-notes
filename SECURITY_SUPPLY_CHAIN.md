...
This repo treats dependency, workflow, app, CLI, skill, and server route changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, app/server source, CLI code, and skills.
